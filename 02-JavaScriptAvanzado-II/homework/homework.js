...
function counter() {
  ...
  // el primer valor deberia ser 1.bi
...
var underscore = {
  delimitadorIzquierda: "_",
  delimitadorDerecha: "_",
}

var crearCadena = function(delimitadorIzquierda, delimitadorDerecha, cadena){
